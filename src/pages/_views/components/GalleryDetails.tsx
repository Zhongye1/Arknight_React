    ...
    <div className="relative w-full h-screen bg-[#111] text-white overflow-hidden font-sans select-none">
      ...
      <div className="absolute top-[20%] left-8 md:left-12 z-20 flex flex-col">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="bg-[#23ADE5] text-black text-xs font-bold px-1 py-0.5 transform -skew-x-12">2026</span>
          </div>
        </div>
              ...
              >
                ...
                <span
                  className={`
                            ...
                            ${
                              isActive
                                ? 'text-[#23ADE5] font-bold scale-110'
      ...
      <div className="absolute bottom-0 left-0 w-full z-20 pl-8 md:pl-12 pb-8 pr-0 flex flex-col md:flex-row items-end justify-between gap-8">
        ...
        <div className="flex-shrink-0 mb-4 md:mb-0">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-bold tracking-tight mb-0 ">{activeItem.title}</h2>
            <div className="flex items-center gap-2 mt-2">
              <span className="text-[#23ADE5] text-lg font-bold tracking-widest">{activeItem.subtitle}</span>
            </div>
            {/* 装饰性蓝线 */}
              ...
              return (
                <div
                  ...
                  className={`
                            ...
                            `}
                >
                  <img src={item.src} alt="" className="w-full h-full object-cover bg-gray-800" />
