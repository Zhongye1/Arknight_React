...
export default function NavMenu() {
  ...
  return (
    <div
      className="w-[5.75rem] h-full landscape:hidden portrait:flex"
    ...
    >
      <div className="w-[2.625rem] h-[2.375rem] m-auto relative">
        ...
        ></div>
        <div
          className={`${LineClassName} top-1/2 -translate-x-1/2 -translate-y-1/2`}
          style={{
        ...
        ></div>
        <div
          className={`${LineClassName} bottom-px -translate-x-1/2 translate-y-1/2`}
          style={{
    ...
    <div className="pt-[1.25rem] pr-[2.25rem] pb-0 pl-[3.375rem]">
      {
        ...
        arknightsConfig.navbar.items.map((item, index) => {
          ...
          return (
            ...
            >
              <div className={`transition duration-300 text-4xl font-oswaldMedium`}>{item.title}</div>
...
function SubNavigation({
  ...
  return (
    <div className="text-4xl font-benderBold overflow-y-auto">
      <button
        className="w-full h-[4.5rem] text-left bg-[#5a5a5a] bg-opacity-80 block pl-[3.375rem]"
...
function ToolBox() {
  ...
  const aClassName = 'text-inherit flex-none cursor-pointer'
  const iconClassName = 'h-auto m-auto pointer-events-none'

  return (
    <div className={'mt-auto pr-9 pb-[4.5rem] pl-[3.375rem]'}>
...
export function Menu({ subNavigationItems }: { subNavigationItems?: SubNavigationItem[] }) {
  ...
  return (
    <div
      className={
        'w-full h-full absolute top-0 left-0 z-[22] overflow-hidden bg-black bg-opacity-90' +
