...
export default function WorldDetails({ item, onBack, onPrevious, onNext, onGoToItem }: WorldDetailsProps) {
  if (!item) {
    return null
  }
        ...
        {items.map((_: any, index: number) => (
          <div
            ...
            className={`h-full flex-1 transition-colors duration-300 ${
              items[index] === item ? 'bg-ark-blue' : 'bg-white/20 hover:bg-white/40'
            } cursor-pointer`}
