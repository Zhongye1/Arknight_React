...
export function Init() {
  ...
  return (
    <div
      className={`fixed inset-0 bg-[#272727] flex flex-col items-center justify-center z-50 font-benderBold transition-opacity duration-1000 ${
        isFadingOut ? 'opacity-0' : 'opacity-100'
      }`}
    >
      {/* 上边线 */}
      <div
        className={`absolute left-0 right-0 h-[0.05vw] bg-[#686767] transition-all duration-1000 ease-in-out ${
          isFadingOut ? 'top-[-5vw]' : 'top-[5vw]'
        }`}
      />
      {/* 右边线 */}
      <div
        className={`absolute top-0 bottom-0 w-[0.05vw] bg-[#686767] transition-all duration-1000 ease-in-out ${
      ...
      <div className="flex flex-col items-center justify-center h-full w-full">
        ...
        <div className="flex items-center justify-center mb-[2vw]">
          <TitleArknights className={`w-[13vw] h-[17vw] max-w-full text-[rgb(164,164,164)]`} />
        </div>
          ...
          <div className={`flex items-start ${isPortrait ? 'flex-col' : ''}`}>
            ...
            <div className={`flex-grow ${isPortrait ? 'w-full' : ''} pl-[5vw] pr-[5.5vw]`}>
              <div className="relative h-[0.3vw] flex items-center" style={{ backgroundColor: 'transparent' }}>
                ...
                <div
                  className="absolute top-[0.1vw] left-0 right-0 h-[0.1vw]"
